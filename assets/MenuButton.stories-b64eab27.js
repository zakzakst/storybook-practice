...
`,R={title:"EXPERIMENTAL/メニューボタン",component:f,parameters:{storySource:{source:`import MenuButton from './MenuButton.vue'\r
\r
...
\r
export const Default = Template.bind({})`,locationsMap:{default:{startLoc:{col:17,line:24},endLoc:{col:2,line:27},startBody:{col:17,line:24},endBody:{col:2,line:27}}}},docs:{description:{component:L}}}},S=o(()=>({components:{MenuButton:f},template:"<MenuButton />"}),"Template"),F=S.bind({}),V=["Default"];export{F as Default,V as __namedExportsOrder,R as default};
//# sourceMappingURL=MenuButton.stories-b64eab27.js.map
